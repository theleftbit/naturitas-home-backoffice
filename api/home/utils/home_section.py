...
def populate_home_sections():
    ...
    HomeSection.objects.update_or_create(id=HomeSection.HOME_SECTION_BANNERS_ID,
                                         defaults={'id': HomeSection.HOME_SECTION_BANNERS_ID,
                                                   'type_id': HomeSectionType.HOME_SECTION_TYPE_BANNERS_ID,
                                                   'priority': 100,
                                                   'images_path': '/media/interactiv4/slidermanager/banner',
                                                   'deeplink_path': ''})

    HomeSection.objects.update_or_create(id=HomeSection.HOME_SECTION_CATEGORIES_ID,
                                         defaults={'id': HomeSection.HOME_SECTION_CATEGORIES_ID,
    ...
    HomeSection.objects.update_or_create(id=HomeSection.HOME_SECTION_BRANDS_ID,
                                         defaults={'id': HomeSection.HOME_SECTION_BRANDS_ID,
